...
clean_training_imp <- predict(clean_training_preProc, clean_training)

clean_testing_imp <- predict(clean_training_preProc, clean_testing)
```
...
rf_model <- train(Survived ~ ., method = "rf", tuneLength = 10, data = clean_training_imp)
```
