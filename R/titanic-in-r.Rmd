...
create_ticket_prefixes <- function(data) {
  ...
  #A4
  data <- data %>% transform(ticket_A4 = str_detect(data$ticket_prefix, "A4"))  
  
  #A5
  data <- data %>% transform(ticket_A5 = str_detect(data$ticket_prefix, "A5"))
  
  #AH
  data <- data %>% transform(ticket_AH = str_detect(data$ticket_prefix, "AH"))
  
  #CA
  data <- data %>% transform(ticket_CA = str_detect(data$ticket_prefix, "CA"))
  
  #FC
  data <- data %>% transform(ticket_FC = str_detect(data$ticket_prefix, "FC"))
  
  #PC
  data <- data %>% transform(ticket_PC = str_detect(data$ticket_prefix, "PC"))
  
  #PP
  data <- data %>% transform(ticket_PP = str_detect(data$ticket_prefix, "PP"))
  
  #SC
  data <- data %>% transform(ticket_SC = str_detect(data$ticket_prefix, "SC"))
  
  #SOC
  data <- data %>% transform(ticket_SOC = str_detect(data$ticket_prefix, "SOC"))
  
  #SOP
  data <- data %>% transform(ticket_SOP = str_detect(data$ticket_prefix, "SOP"))
  
  #SOTON
  data <- data %>% transform(ticket_SOTON = str_detect(data$ticket_prefix, "(SOTON|STON)"))
  
  #SP
  data <- data %>% transform(ticket_SP = str_detect(data$ticket_prefix, "SP"))
  
  #SW
  data <- data %>% transform(ticket_SW = str_detect(data$ticket_prefix, "SW"))
  
  #O2
  data <- data %>% transform(ticket_O2 = str_detect(data$ticket_prefix, "O2"))
  
  #OQ
  data <- data %>% transform(ticket_OQ = str_detect(data$ticket_prefix, "OQ"))
  
  #WC
  data <- data %>% transform(ticket_WC = str_detect(data$ticket_prefix, "WC"))
  
  #WEP
  data <- data %>% transform(ticket_WEP = str_detect(data$ticket_prefix, "WEP"))
...
```{r}
train$Cabin[train$Cabin %>% str_detect(" ")] %>% unique()
```
...
names(drop_features(engineer_features(train)))
```
