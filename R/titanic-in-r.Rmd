...
The first two variables Survived and Pclass are exactly as described, and shouldn't require any further wrangling.
```{r}
...
We can see that the one eighty year old made it out, making that bar stand out. We also see that young children and early adolescents seem to have done well, and that survival generally decreases with age. Let's break this down by gender:
```{r}
...
The above pattern is far more striking when we isolate for males. Children did fairly well, but survival rates tend to crash for those above the age of 15. 
